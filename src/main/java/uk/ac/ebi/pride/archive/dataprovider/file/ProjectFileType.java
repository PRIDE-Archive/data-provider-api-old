...
public enum ProjectFileType {
    ...
    EXPERIMENTAL_DESIGN("EXPERIMENTAL_DESIGN",11), // Experimental design sdrf file
    OTHER("OTHER", 12);  // any other files that are not in the other predefined categories
